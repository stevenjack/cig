...
```bash
curl -L https://github.com/stevenjack/cig/releases/download/v0.1.6/cig_`uname -s`_x86_64 > /usr/local/bin/cig
...
* [64bit](https://github.com/stevenjack/cig/releases/download/v0.1.6/cig_windows_x86_64.exe)
